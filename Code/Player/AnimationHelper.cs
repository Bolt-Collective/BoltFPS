...
public sealed class AnimationHelper : Component, Component.ExecuteInEditor
{
	...
	/// </summary>
	[Property, ToggleGroup( "LookAtEnabled" )]
	public GameObject LookAt { get; set; }

	[Property, ToggleGroup( "LookAtEnabled" ), Range( 0, 1 )]
	...
	[Property, Group( "Inverse kinematics" ), Title( "Right Hand" )]
	public GameObject IkRightHand { get; set; }

	/// <inheritdoc cref="IkLeftHand"/>
	[Property, Group( "Inverse kinematics" ), Title( "Left Foot" )]
	public GameObject IkLeftFoot { get; set; }

	/// <inheritdoc cref="IkLeftHand"/>
	[Property, Group( "Inverse kinematics" ), Title( "Right Foot" )]
	public GameObject IkRightFoot { get; set; }
